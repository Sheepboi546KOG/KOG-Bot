        ...
        embeds: [
          {
            title: "No Permission",
            description:
              "You cannot run this command in this server. Please use in the main server.",
            color: 0xed4245,
          },
        ],
        ephemeral: true,
        ...
        embeds: [
          {
            title: "No Permission",
            description:
              "You cannot run this command as you do not have permission.",
            color: 0xed4245,
          },
        ],
        ephemeral: true,
          ...
          embeds: [
            {
              title: "Event Started",
              description:
                `The event has started! Hosted by: **<@${interaction.user.id}>**.\n\nPlease join the event if you haven't already.` +
                (notes ? `\n\n**Notes:** ${notes}` : "") +
                (link ? `\n\n[Join the event](${link})` : ""),
              color: 0x57f287,
            },
        ...
        embeds: [
          {
            title: "Event Started",
            description:
              `You have successfully started the event with ID: ${eventId}.` +
              (notes ? `\n\n**Notes:** ${notes}` : "") +
              (link ? `\n\n[Join the event](${link})` : ""),
            color: 0x57f287,
          },
